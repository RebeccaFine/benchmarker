...
# consistent
prio_gene_list=@_magma_Top50GenesPerGeneSet_Top10PercentGenes_Genes.txt
output_directory=./
label=magma
...
prio_gene_list_has_header=True
gene_col_name=Ensembl_Gene
